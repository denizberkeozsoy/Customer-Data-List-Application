...
--Type of variables in customer data
...
-- List of all customers with all their rela
customers :: [Customer]
customers =     [ Customer {customerId = 1, firstName = "Charlotte", lastName = "White", age = 56, email = "Isabella@hotmail.com", balance = 5645.416, riskNote = "Medium"}
